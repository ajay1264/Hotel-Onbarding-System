...
const GuestForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:5000/api/guests', formData); // Updated route
...
//     try {
//       const response = await axios.post('http://localhost:5000/api/guests/register', formData);
//       console.log('Guest registered:', response.data);
//       setIsSubmitted(true);  // Mark form as submitted
